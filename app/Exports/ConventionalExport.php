...
class ConventionalExport implements FromCollection
{
    protected $request;
    ...
    public function collection()
    {
        ...
        $data = [];
        $headerRow = ['Rank', 'Circle', 'Conventional Name'];
        // foreach ($platform as $item) {
        //     $headerRow[] = $item->name;
        // }
        $headerRow[] = 'Total Income';
        $dateRange = "Conventional Report Date : {$startCarbon->day}-{$startMonth}-{$startCarbon->year} to {$endCarbon->day}-{$endMonth}-{$endCarbon->year}";
