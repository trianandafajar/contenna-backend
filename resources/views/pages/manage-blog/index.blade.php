            ...
            <div class="card">
                <div class="card-header border-0 pt-6 flex flex-col-reverse sm:flex-row">
                    ...
                    <div class="card-title">
                        <form action="{{ route('manage-blog.index') }}" method="GET" class="d-flex gap-3 align-items-center">
                    ...
                    <div class="card-toolbar">
                        <div class="flex justify-end sm:justify-start w-full max-w-full">
                            @can('manage-blog-create')
                                <a href="{{ route('manage-blog.create') }}" class="btn btn-primary !w-full text-center flex items-center justify-center">
                                ...
                                @foreach ($blogs as $blog)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="display: inline-block; width: 100px; height: 100px; overflow: hidden; border-radius: 8px;">
                                        ...
                                        <td>
                                            <a href="{{ route('manage-blog.show', $blog->slug) }}" class="text-gray-800 fw-bold text-hover-primary">
                                                {{ $blog->title }}
                                            </a>
                                        </td>
                                        <td>{{ \Illuminate\Support\Str::limit($blog->slug, 50) }}</td>
                                        <td>{{ $blog->category->name ?? '-' }}</td>
                                        <td>{{ $blog->user->name ?? '-' }}</td>
                                        <td>{{ $blog->status == 1 ? 'publish' : 'draft' }}</td>
                                        <td class="text-end">
                                            @canany(['manage-blog-edit', 'manage-blog-view', 'manage-blog-delete'])
                                                <a href="#"
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    @can('manage-blog-edit')
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('manage-blog.edit', $blog->slug) }}" class="menu-link px-3">
                                                                Edit
                                                            </a>
                                                        </div>
                                                    @endcan
                                                    ...
                                                    @can('manage-blog-view')
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('manage-blog.show', $blog->slug) }}" class="menu-link px-3">
                                                                Show
                                                            </a>
                                                        </div>
                                                    @endcan
                                                    ...
                                                    @can('manage-blog-delete')
                                                        <x-delete-confirmation-2 :id="$blog->id" :route="route('manage-blog.destroy', $blog->slug)" />
                                                    @endcan
                                                </div>
                                                <!--end::Menu-->
                                            @endcanany
