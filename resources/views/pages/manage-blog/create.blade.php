<x-app-layout>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid" style="background-color: #f6f6f6;}">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid"
            ...
            <!--begin::Card-->
            <div class="card">
                <form class="form" action="{{ route('manage-blog.store') }}" method="POST"
                                ...
                                <select name="author_id" id="author_id" data-control="select2"
                                    ...
                                    @foreach ($authors as $author)
                                        <option value="{{ $author->id }}"
                                            {{ old('author_id') == 1 ? 'selected' : '' }}>{{ $author->name }}</option>
                                    @endforeach
                                </select>
