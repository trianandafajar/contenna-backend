                ...
                <form class="form" action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body py-4">
                        ...
                        <textarea name="content" id="content" 
                            class="form-control form-control-solid mb-3 mb-lg-0 {{ $errors->get("content") ? "is-invalid border border-1 border-danger" : "" }}" rows="4" placeholder="Insert content...">{{ old('content') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted d-block mb-2">AI will scan <strong>Title</strong> &amp; <strong>Category</strong> and generate the content automatically.</small>
                        ...
                        <div class="mb-7">
                            ...
                            <input type="file" name="thumbnail" id="thumbnail"
                                class="form-control form-control-solid mb-3 mb-lg-0 {{ $errors->get('thumbnail') ? 'is-invalid border border-1 border-danger' : '' }}"
                                value="{{ old('thumbnail') }}" accept="image/jpeg, image/png, image/jpg"  />
                            ...
                            <div class="mb-7">
                                <div class="d-flex fv-row mt-3">
                                    <div class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input me-1 border border-1 border-dark cursor-pointer" name="special_role"
                                            type="checkbox" value="2" id="role_"
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button type="submit" class="btn btn-primary me-3" name="save_draft" value="2">
                            <span class="indicator-label" id="submitAndOther">Save as Draft</span>
                        </button>
                        <button type="submit" class="btn btn-primary" name="save" value="1">
                            <span class="indicator-label" id="submit">Publish</span>
                        </button>
                    </div>
                </form>
            </div>
