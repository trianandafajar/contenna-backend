                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <form action="{{ route('master.tags.index') }}" method="GET">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a href="{{ route('master.tags.create') }}" class="btn btn-primary">
                            ...
                            @foreach ($tags as $tag)
                                <tr>
                                    ...
                                    <td class="text-start pe-0" data-order="38">
                                        <a href="{{ route('master.tags.show', $tag->id) }}"><span class="text-gray-800 fw-bold text-hover-primary">{{ $tag->name }}</span></a>
                                    </td>
                                    <td>{{ $tag->slug }}</td>
                                    <td class="text-end">
                                        <a href="#"
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('master.tags.edit', $tag->id) }}"
                                                    class="menu-link px-3">Edit</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="{{ route('master.tags.show', $tag->id) }}"
                                                    class="menu-link px-3">Show</a>
                                            </div>
                                            <x-delete-confirmation :id="$tag->id" :route="route('master.tags.destroy', $tag->id)" />
                                        </div>
                                        <!--end::Menu-->
                                    </td>
                                </tr>
