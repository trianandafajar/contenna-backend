                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <form action="{{ route('master.categories.index') }}" method="GET">
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="text-start pe-0" data-order="38">
                                        <a href="{{ route('master.categories.show', $category->id) }}"><span class="text-gray-800 fw-bold text-hover-primary">{{ $category->name }}</span></a>
                                    </td>
                                    <td>{{ $category->slug }}</td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <x-delete-confirmation :id="$category->id" :route="route('master.categories.destroy', $category->id)" />
                                        </div>
                                        <!--end::Menu-->
                                    </td>
                                </tr>
